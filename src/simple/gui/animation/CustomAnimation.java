...
public class CustomAnimation implements Animatable {
    public static class Generator {
        ...
        public CustomAnimation generate(int x, int y) {
            return generate(_drawSurface, x, y, _offsetx, _offsety);
        }
        public CustomAnimation generate(Image drawSurface, int x, int y) {
            return generate(drawSurface, _offsetx, _offsety);
        }
        public CustomAnimation generate(int x, int y, int offsetx, int offsety) {
            return generate(_drawSurface, x, y, offsetx, offsety);
        }
        public CustomAnimation generate(Image drawSurface, int x, int y, int offsetx, int offsety) {
            return new CustomAnimation(drawSurface, _animator, x+_offsetx, y+_offsety, _loop);
        }
    ...
    public CustomAnimation(Image drawSurface, Animator animator, int offsetx, int offsety, boolean loop) {
        this(drawSurface, animator, 0, 0, offsetx, offsety, loop);
    }
    public CustomAnimation(Animator animator, int offsetx, int offsety, boolean loop) {
        this(null, animator, 0, 0, offsetx, offsety, loop);
    }
    public CustomAnimation(Animator animator, int x, int y, int offsetx, int offsety, boolean loop) {
        this(null, animator, x, y, offsetx, offsety, loop);
    }
    public CustomAnimation(Image drawSurface, Animator animator, int x, int y, int offsetx, int offsety, boolean loop) {
        _drawSurface   = drawSurface;
        _animator      = animator;
